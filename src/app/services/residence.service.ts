...
export class ResidenceService {
  ...
  setWishlist(residence: Residence): void {
    if (residence.favorite === true) {
      this.whishlist.push(residence);
      console.log(residence.likeBtn);
    } else {
      this.whishlist = this.whishlist.filter(
